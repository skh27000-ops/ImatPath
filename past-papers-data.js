const pastPapersData = {
  "2024": [
    ...
    {
      "id": 5,
      "question": "The following table shows the results of a test:<br><br>\n<table style=\"width:100%; border-collapse: collapse; margin-bottom: 16px; font-weight: normal; font-size: 0.95rem; text-align: center;\">\n  <tr>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px; font-weight: bold; background: var(--stone-2);\">mark</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">0</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">1</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">2</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">3</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">4</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">5</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">6</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">7</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">8</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">9</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">10</td>\n  </tr>\n  <tr>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px; font-weight: bold; background: var(--stone-2);\">frequency</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">1</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">4</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">4</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">6</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">2</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">1</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">1</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">2</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">2</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">1</td>\n    <td style=\"border: 1px solid var(--stone-3); padding: 8px;\">0</td>\n  </tr>\n</table>\nTo pass the test, a mark of higher than 5 is needed. What percentage of the candidates passed the test?",
      "options": [
        "30%",
        "25%",
        "24%",
    ...
    {
      "id": 6,
      "question": "Shelly is one of 1500 participants in a Latin contest. 12% of the participants will receive as a prize either a silver-plated or gold-plated pen. If the number of silver-plated pens is twice the number of gold-plated ones, what is the probability that Shelly will receive a gold-plated one?",
      "options": [
        "67%",
        "4%",
        "6%",
    ...
    {
      "id": 8,
      "question": "Stacie builds a cube using 343 blocks of wood. She decides to paint the cube green. How many of the wooden blocks will have at least one side painted green?",
      "options": [
        "218",
        "125",
        "245",
    ...
    {
      "id": 33,
      "question": "A mixture of 0.3 mol of N₂, 0.5 mol of CO₂, and 0.4 mol of O₂ exerts a pressure of 2.4 atm on the walls of the vessel that contains it. What is the pressure exerted by the nitrogen?",
      "options": [
        "0.8 atm",
        "0.75 atm",
        "0.3 atm",
    ...
    {
      "id": 34,
      "question": "A gas, confined in a rigid cylinder and maintained at a temperature of -3 °C exerts a pressure of 9 atm. What pressure would the same gas exert if it were heated to 27 °C?",
      "options": [
        "9.6 atm",
        "8.1 atm",
        "12.5 atm",
    ...
    {
      "id": 36,
      "question": "Given the theoretical reaction yield of 4 FeS₂ + 11 O₂ → 2 Fe₂O₃ + 8 SO₂ which of the following statements is correct",
      "options": [
    ...
    {
      "id": 37,
      "question": "How many mL of water must be added to 15 mL of a 0.25 M solution of H₂SO₄ to obtain a 0.05 M solution?",
      "options": [
        "75 mL",
        "50 mL",
        "60 mL",
    ...
    {
      "id": 40,
      "question": "Zinc nitrate, nitrogen dioxide, and water are obtained from the reaction of metallic zinc and nitric acid in an aqueous solution. What is the reducing species?",
      "options": [
        "H⁺(aq)",
        "Zn(NO₃)₂(aq)",
        "Zn²⁺(aq)",
    ...
    {
      "id": 43,
      "question": "Various units of measurement can be used to express the value of pressure. Which of the following values of pressure does NOT correspond to 1 atm?",
      "options": [
        "1013.25 kPa",
        "1013 millibar",
        "760 mmHg",
    ...
    {
      "id": 44,
      "question": "Given that the relative atomic mass of nitrogen is 14 u, how many nitrogen atoms are present in 0.7 g of gaseous nitrogen?",
      "options": [
        "3.01×10²²",
        "3.01×10²³",
        "2.01×10²³",
    ...
    {
      "id": 45,
      "question": "Carbon and oxygen can react at high temperatures to form CO₂. Assuming that the relative atomic mass of the carbon is 12 u, the relative atomic mass of the oxygen is 16 u and the yield of the reaction is 100%, what happens when 9 g of carbon reacts with 36 g of oxygen?",
      "options": [
    ...
    {
      "id": 46,
      "question": "How much water needs to be added to 1 mL of an HCl solution with a pH of 2 to obtain a solution with a pH of 4?",
      "options": [
        "1 mL",
        "24 mL",
        "49 mL",
    ...
    {
      "id": 48,
      "question": "The expression (512^(1/3))^(1/2) is equivalent to:",
      "options": [
        "2√2",
        "³√4",
        "2⁴√2",
    ...
    {
      "id": 49,
      "question": "If f(x) = log₂(x² + 12)\nWhat is the reciprocal of f(2)?",
      "options": [
        "1/4",
        "4",
        "6",
    ...
    {
      "id": 50,
      "question": "In a bag are 3 red balls and 7 green balls, indistinguishable by touch. Two extractions are made, with the first ball being returned to the bag before the second extraction. What is the probability of extracting 2 green balls?",
      "options": [
        "9/100",
        "42/90",
        "51/100",
    ...
    {
      "id": 52,
      "question": "Let 𝜑 be the acute angle formed between the tangent at point A to a circle and one of its chords, AB. Considering any point D on the larger of the arcs AB, denoted by 𝜗 as the angle ADB, what relationship exists between the angles 𝜑 and 𝜗?",
      "options": [
        "They are complementary.",
        "They are equal.",
        "They are explementary.",
    ...
    {
      "id": 53,
      "question": "Given a cylinder with a base radius of 5 cm and a height of 7 cm, what is its volume?",
      "options": [
        "175𝜋 cm³",
        "70𝜋 cm³",
        "This cannot be calculated with these data",
        "245𝜋 cm³",
        "105𝜋 cm³"
      ],
      "correct": 0,
    ...
    {
      "id": 54,
      "question": "In a right triangle, let a and b represent the legs and c the hypotenuse. If α is the angle opposite a, which of the following relations is true?",
      "options": [
        "a = b cos(α)",
        "a = c cos(α)",
        "c = a sin(α)",
    ...
    {
      "id": 55,
      "question": "A boat is moving in a uniform straight motion at a certain speed v. If a braking force of 210 N is applied for a distance of 5 m, how much power is developed by the braking force?",
      "options": [
        "210 W",
        "420 W",
        "105 W",
    ...
    {
      "id": 56,
      "question": "An ideal gas is in a container placed on a thermostat at temperature T and occupies volume V at pressure P. If the volume occupied by the gas is tripled while keeping the temperature constant, its pressure ...",
      "options": [
        "changes, depending on T",
        "becomes 3P",
        "becomes P/3",
        "becomes P/2",
        "does not change"
    ...
    {
      "id": 57,
      "question": "In a conductor, when a current of 10A flows, 2922W are dissipated. What is the resistance value of the conductor?",
      "options": [
        "2.922 Ω",
        "292.2 Ω",
        "29.22 Ω",
    ...
    {
      "id": 58,
      "question": "An electron in motion with a constant velocity 𝑣, enters a uniform magnetic field B perpendicularly. Given that me, e, 𝑣 represent the mass, charge, and magnitude of the electron's velocity respectively, which of the following statements is false?",
      "options": [
        "The motion of the electron is circular with constant angular velocity",
        "The motion of the electron is uniformly circular with a period of 2𝜋me / eB",
        "The trajectory of the electron is a circle with a radius of me𝑣 / eB",
        "The motion of the electron is uniformly circular with a frequency eB / 2𝜋me",
        "The electron continues to move with a constant velocity 𝑣"
      ],
      "correct": 4,
      "section": "Physics and Mathematics",
      "explanation": "Option A was originally the correct answer."
    ...
    {
      "id": 59,
      "question": "A point particle moves along a given x-axis with the law of motion x(t) = 4 cos(ωt) where x is in metres, t in seconds and ω = 2𝜋 rad/s. The velocity of the point particle at the instant t* = 1/2s equals:",
      "options": [
  ...
  "2025": [
    ...
    },
    {
      ...
      "options": [
        "In the first part, FADH2 is formed.",
        "When a molecule of glucose is converted to pyruvate in glycolysis, CO2 is produced.",
